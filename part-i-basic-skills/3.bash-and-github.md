...
2\) Copy your ssh key to github website \([set up ssh key](2.linux/#4-setup-ssh-key)\)  
...
* **for Advanced Readers **
  ...
  * [**Additional Tutorial**](https://youngleebbs.gitbook.io/bioinfo-training)**: **Bash
...
2. 学习和完成这里面的作业：[**Additional Tutorial**](https://youngleebbs.gitbook.io/bioinfo-training) : Bash \([相关教学视频](http://list.youku.com/albumlist/show/id_51618375.html)：Week II. Bash and R -- Shared by Li\)
